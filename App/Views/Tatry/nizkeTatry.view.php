<div class="container">
    <div class="row farba-text p-2 rounded-2 border border-dark mb-4">
        <img src="public/img/nizke_tatry/nizke_tatry.jpg" class="img-fluid" alt="Nizke Tatry panorama">
    </div>
    <div class="row farba-text p-2 rounded-2 border border-dark mb-4">
        <h1 class="text-center p-1">Nízke Tatry</h1>
        <p>
            Nízke Tatry sú pohorie a geomorfologický celok v Západných Karpatoch na Slovensku. V centrálnej časti pohoria
            bol vyhlásený národný park - NAPANT. Geomorfologický celok sa člení na dva geomorfologické podcelky: Ďumbierske Tatry v
    ...
    <div class="row farba-text p-2 rounded-2 border border-dark mb-4">
        <h3>Vrcholy</h3>
        <hr>
        <p>Hrebeň prekračuje štyrmi vrcholmi nadmorskú výšku 2 000 m:</p>
        <div class="col">
            <ul>
