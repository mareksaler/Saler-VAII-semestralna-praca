<div class="container">
    <div class="row farba-text p-2 rounded-2 border border-dark mb-4">
        <img src="public/img/zapadne_tatry/zapadne_tatry1.jpg" class="img-fluid" alt="Zapadne Tatry panorama">
    </div>
    <div class="row farba-text p-2 rounded-2 border border-dark mb-4">
        <h1 class="text-center p-1">Západné Tatry</h1>
        <p>
            Západné Tatry sú geomorfologický podcelok Tatier. Rozloha pohoria je 380 km², z toho 286 km² (75,2 %) sa nachádza na Slovensku a 94 km² (24,8 %) v Poľsku. Najväčšia časť pohoria sa nachádza na Liptove, menšia časť na Orave a asi štvrtina územia v Poľsku. Hranicu s Vysokými Tatrami na východe tvorí Ľaliové sedlo, s Chočskými vrchmi na západe Suchá dolina a Hutianske sedlo. Vyznačujú sa výrazným, veľmi kľukatým hlavným hrebeňom v dĺžke 35 km, kde značná časť vrcholov má výšku nad 2000 m. Najvyšším vrcholom hlavného hrebeňa je Baníkov (2178 m) a najvyšší vrch Bystrá (2248 m) je necelý kilometer južne od hlavného hrebeňa.
        </p>
    </div>
    <div class="row farba-text p-2 rounded-2 border border-dark mb-4">
        <h3>Vrchy a sedlá</h3>
        <hr>
        <p>Najvyššie vrchy Západných Tatier sú:</p>
        <div class="col">
            <ul>
                ...
                <li>Tri kopy (2 136,3 m n. m.), výrazný a ľahko spoznateľný útvar v hlavnom hrebeni Západných Tatier</li>
        ...
        <div class="col">
            <ul>
                ...
                <li>Mládky (1 945,0 m n. m.), pri pohľade z Liptova pomerne výrazný hôľny vrch v JV rázsoche Baranca</li>
                ...
                <li>Osobitá (1 687,2 m n. m.), skalnatý výrazný vrch nad Blatnou dolinou, súčasť NPR Osobitá a ďalšie</li>
            </ul>
        </div>
    </div>
    <div class="row">
